...
public class CeotocfTestContainer extends TestContainer {

    public CeotocfTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/rtcab/ceotocf/app.properties",
    ...
    public static class Common extends CeotocfTestContainer {

        public static final CeotocfTestContainer.Common INSTANCE = new CeotocfTestContainer.Common();
